...
class trans_infer:
    def __init__(self,tokenizer,token_dict):
         ...
         self.config_path = '/opt/developer/wp/nlpapp/train/multilingual_L-12_H-768_A-12/bert_config.json'
         self.model_path = os.path.join(os.path.dirname(__file__),"models/best_trans.weights")
         self.graph = tf.Graph()
